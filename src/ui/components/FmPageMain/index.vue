...
<template>
  ...
  >
    ...
    >
      <slot />
      <FmButton v-if="collaspe" variant="link" size="icon" class="absolute inset-b-0 inset-s-1/2 transition-all -translate-x-1/2" :class="{ 'rotate-x-180': !isCollaspe }" @click="handleCollaspe">
