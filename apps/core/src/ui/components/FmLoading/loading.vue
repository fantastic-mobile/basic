...
<template>
  <Transition name="loading" appear @after-leave="emits('afterLeave')">
    <div v-if="modelValue" class="bg-background/50 w-full bottom-0 top-0 fixed z-10010 backdrop-blur-sm">
      <div class="flex-col-center gap-4 left-1/2 top-1/2 absolute -translate-x-1/2 -translate-y-1/2">
        <div class="flex-center" :style="{ '--sk-size': `${size}px`, '--sk-color': 'oklch(var(--primary))' }">
